...
import com.ou.services.HomepageAdminService;
...
public class HomepageAdminController implements Initializable {
    private final static HomepageAdminService HOMEPAGE_ADMIN_SERVICE;

    static {
        HOMEPAGE_ADMIN_SERVICE = new HomepageAdminService();
    }
    ...
    private static Integer id = 0;   // biến này nhận idAccount từ signIn
    ...
    private void setInfoAcount() {
        ...
        staff = HOMEPAGE_ADMIN_SERVICE.getStaff(id);
        if (staff.getPersId() > 0) {
            ...
            this.lblSex.setText(":   " + staff.getSex());
